...
#	wget http://www2.vaneay.fr/mifare/craptev1-v1.1.tar.xz
	wget http://web.archive.org/web/20190221140220if_/http://www2.vaneay.fr/mifare/craptev1-v1.1.tar.xz
	tar Jxvf craptev1-v1.1.tar.xz

get_crapto1:
#	wget http://www2.vaneay.fr/mifare/crapto1-v3.3.tar.xz
	wget http://web.archive.org/web/20190221140255if_/http://www2.vaneay.fr/mifare/crapto1-v3.3.tar.xz
	mkdir crapto1-v3.3
